...
<<<<<<< HEAD
// Import the TWO background components for the homepage
...
// --- Hero Component ---
// This is specific to the homepage, so it's fine to define it here.
const Hero: React.FC = () => {
  const [startAnimation, setStartAnimation] = useState(false);

  useEffect(() => {
    // Start the typewriter animation after the loader finishes (e.g., 2.5 seconds)
    const timer = setTimeout(() => {
      setStartAnimation(true);
    }, 2500); // This delay should match your Loader's duration

    return () => clearTimeout(timer);
  }, []);

  return (
    <section id="hero" className="relative h-screen flex items-center justify-center text-center overflow-hidden z-10">
...
const Hero: React.FC = () => {
  return (
    <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
      {/* This overlay dims the grid for the Hero section */}
>>>>>>> 528c098c898fd56b045b64d101edbe2cbf60c854
      ...
      <div className="relative z-20 p-6 text-white max-w-4xl">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-4 leading-tight" style={{ whiteSpace: "pre-line", minHeight: "150px" }}>
...
<<<<<<< HEAD
    <>
      ...
      <main>
        ...
        {/* The per-section 3D effects will be inside this wrapper */}
...
=======
    <main>
      ...
      {/*
        --- THIS IS THE FIX ---
        We wrap all content sections in a div with a semi-transparent
        background. This makes the text readable over the grid.
      */}
      <div className="relative z-10 bg-gray-950/40 backdrop-blur-sm">
        <AboutSection />
        <OfferSection />
        <FacultySection />
        <GalleryPreview />
